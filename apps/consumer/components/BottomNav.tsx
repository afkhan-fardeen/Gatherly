...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[430px] bg-white/90 ios-blur border-t border-slate-100 px-10 py-4 pb-8 flex justify-between items-center rounded-none z-50 md:hidden">
